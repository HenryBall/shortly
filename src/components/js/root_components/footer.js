		...
		return (
			<div className='content'>
				<div id='squeeze'>
					...
					<div id='sub-text' className='squeeze-more light-grey-color'>Links are what drive the flow of information on the internet. Whether you want to simplify the link to your band's facebook profile, or are running a small buisness, make sure your URLs are as efficient as possible. Get started today!</div>
